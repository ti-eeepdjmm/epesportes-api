  ...
  beforeEach(async () => {
    ...
    const module: TestingModule = await Test.createTestingModule({
      providers: [
        ...
        { provide: getRepositoryToken(EngagementStat), useValue: mockRepository },
        { provide: getRepositoryToken(User), useValue: mockRepository },
      ],
    }).compile();

    service = module.get<EngagementStatsService>(EngagementStatsService);
    engagementStatRepository = module.get<Repository<EngagementStat>>(getRepositoryToken(EngagementStat));
